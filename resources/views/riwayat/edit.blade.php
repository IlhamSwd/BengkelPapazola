...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header text-dark" style="font-weight: bold;">Edit Riwayat Servis</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('riwayat.update', $riwayat['id']) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="stok_id" name='stok_id' placeholder="Masukan nama barang">
                                    @foreach ($stok as $item)
                                        <option value="{{ $item['id'] }}">
                                            {{$item['nama_barang']}}
                                        </option>

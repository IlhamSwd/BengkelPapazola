                    ...
                    <div class="col-xl-6 offset-xl-3">
                        <div class="text-box mt-5 mb-5">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mb-4 form-floating">
                                    <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="Masukan Password" required>
                                    <label for="password_confirmation">Confirm Password</label>
                                </div>
                                <button type="submit" class="form-control-submit-button">Submit</button>
                                <p class="mb-4 text-center">Already signed up? Then just <a class="blue" href="{{ route('login') }}">Log In</a></p>
                            </form>
                            <!-- end of sign up form -->
